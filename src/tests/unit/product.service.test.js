...
describe('Product Services', () => {
  ...
  describe('getProductsByCategory', () => {
    it('should throw an error if categoryId is invalid', async () => {
      ...
      await expect(productServices.getProductsByCategory(undefined)).rejects.toThrow(
        'Category id is invalid.',
      );
  ...
  describe('addProduct', () => {
    ...
    it('should add a new product', async () => {
      ...
      const product = await productServices.addProduct('Product 1', 10, 'image.jpg', 1);
  ...
  describe('updateProductStatus', () => {
    ...
    it('should update product status', async () => {
      ...
      const updatedProduct = await productServices.updateProductStatus(1, 'inactive');
  ...
  describe('deleteProduct', () => {
    it('should throw an error if productId is invalid', async () => {
      ...
      await expect(() => productServices.deleteProduct(undefined)).rejects.toThrow(
        'Product ID is invalid',
      );
