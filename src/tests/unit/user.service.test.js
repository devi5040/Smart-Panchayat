...
describe('User Services', () => {
  ...
  describe('getSignedUrlS3', () => {
    ...
    it('should throw an error if an error occurs', async () => {
      ...
      await expect(() => userServices.getSignedUrlS3(fileName, fileType)).rejects.toThrow();
    });
  });
  ...
  describe('getUserByMobileNumber', () => {
    ...
    it('should throw an error if an error occurs', async () => {
      ...
      await expect(() => userServices.getUserByMobileNumber(mobileNumber)).rejects.toThrow();
    });
  });
  ...
  describe('updateUserDetails', () => {
    ...
    it('should throw an error if ID is invalid', async () => {
      ...
      await expect(() => userServices.updateUserDetails({ userId, data })).rejects.toThrow(
        'Invalid user ID: ID cannot be null or undefined',
      );
    });
  ...
  describe('setPreferredLanguage', () => {
    ...
    it('should throw an error if ID is invalid', async () => {
      const userId = null;
      const language = 'en';
      await expect(() => userServices.setPreferredLanguage(userId, language)).rejects.toThrow(
        'Invalid user ID: ID cannot be null or undefined',
      );
    });
  ...
  describe('changeUserRole', () => {
    ...
    it('should throw an error if ID is invalid', async () => {
      const userId = null;
      const role = 'user';
      await expect(() => userServices.changeUserRole(userId, role)).rejects.toThrow(
        'Invalid user ID: ID cannot be null or undefined',
      );
    });
  ...
  describe('addPassword', () => {
    ...
    it('should throw an error if ID is invalid', async () => {
      const userId = null;
      const password = 'password123';
      await expect(() => userServices.addPassword(userId, password)).rejects.toThrow(
        'Invalid user ID: ID cannot be null or undefined',
      );
    });
  ...
  describe('updatePassword', () => {
    ...
    it('should throw an error if old password is incorrect', async () => {
      ...
      await expect(() =>
        userServices.updatePassword(userId, oldPassword, newPassword),
      ).rejects.toThrow("The old password you entered doesn't match with the saved password.");
    });
