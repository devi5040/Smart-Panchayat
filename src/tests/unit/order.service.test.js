...
describe('Order Service', () => {
  ...
  describe('getOrders', () => {
    ...
    it('should throw error if orders undefined/null', async () => {
      ...
      await expect(orderService.getOrders()).rejects.toThrow('Order is undefined/null');
    });
  });
  ...
  describe('getOrderHistory', () => {
    ...
    it('should throw NotFoundError if user not found', async () => {
      Users.findByPk.mockResolvedValue(null);
      await expect(orderService.getOrderHistory(1)).rejects.toThrow(NotFoundError);
    });
  });
  ...
  describe('updatePaymentStatus', () => {
    ...
    it('should throw NotFoundError if order not found', async () => {
      ...
      await expect(orderService.updatePaymentStatus(1, 'paid')).rejects.toThrow(NotFoundError);
    });
  });
  ...
  describe('getOrderByCollectionCentre', () => {
    ...
    it('should throw NotFoundError if no orders found', async () => {
      ...
      await expect(orderService.getOrderByCollectionCentre('Centre A')).rejects.toThrow(
        NotFoundError,
      );
    });
  });
